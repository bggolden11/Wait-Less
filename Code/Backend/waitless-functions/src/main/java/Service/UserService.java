...
public class UserService {
 ...
 TODO: This request should really be returning a CREATED (201).
    */
     ...
     */
    public HttpResponseMessage createUser(HttpRequestMessage<Optional<CreateUserRequest>> request, String firstName, String lastName, String isManager, String title) {
        ...
        try {
                String employeeID = userDBO.createUser(encryptedPassword, firstName, lastName, isManager, title);
