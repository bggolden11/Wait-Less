...
public class Function {
  ...
  public HttpResponseMessage run(
    ...
    if (name == null) {
      ...
      return request
          ...
          .body("Harsh is very pretty " + name)
          .build();
    }
  }
  ...
  public HttpResponseMessage AddUser(
      @HttpTrigger(
              ...
              authLevel = AuthorizationLevel.FUNCTION)
          HttpRequestMessage<Optional<CreateUserRequest>> request,
      final ExecutionContext context) {
    ...
    if (createUserRequest != null)
      return userService.createUser(
          ...
          createUserRequest.encryptedPassword);
    else {
      return request
          .createResponseBuilder(HttpStatus.BAD_REQUEST)
          .body("Please input a valid username and password")
          .build();
    }
  }
  ...
  public HttpResponseMessage AuthenticateUser(
      @HttpTrigger(
              ...
              methods = {HttpMethod.GET, HttpMethod.POST},
              authLevel = AuthorizationLevel.FUNCTION)
          HttpRequestMessage<Optional<UserAuthenticationRequest>> request,
      final ExecutionContext context) {
    String query = request.getQueryParameters().get("name");
    UserAuthenticationRequest userAuthenticationRequest = request.getBody().orElse(null);
    if (userAuthenticationRequest != null) {
      return userService.authenticate(
          request, userAuthenticationRequest.employeeID, userAuthenticationRequest.passwordtoken);
    } else {
      return request
          .createResponseBuilder(HttpStatus.BAD_REQUEST)
          .body("Please input a valid username and password")
  ...
  public HttpResponseMessage getEmployee(
      @HttpTrigger(
              ...
              methods = {HttpMethod.GET, HttpMethod.POST},
              authLevel = AuthorizationLevel.FUNCTION)
          HttpRequestMessage<Optional<GetEmployeeRequest>> request,
      final ExecutionContext context) {
    String query = request.getQueryParameters().get("name");
    ...
    if (getEmployeeRequest != null) {
      ...
      return request
          .createResponseBuilder(HttpStatus.BAD_REQUEST)
          .body("Please input a valid employeeId")
          .build();
    }
  }
  ...
  public HttpResponseMessage finishTask(
      @HttpTrigger(
              ...
              methods = {HttpMethod.POST},
              authLevel = AuthorizationLevel.FUNCTION)
          HttpRequestMessage<Optional<FinishTaskRequest>> request,
      final ExecutionContext context) {
    FinishTaskRequest finishTaskRequest = request.getBody().orElse(null);
    if (finishTaskRequest != null) return taskService.finishTask(request, finishTaskRequest.taskID);
    else {
      return request
          .createResponseBuilder(HttpStatus.BAD_REQUEST)
          .body("Please input a valid username and password")
  ...
  public HttpResponseMessage updateTaskUser(
    ...
    if (updateUserToTaskRequest != null)
      return taskService.updateTaskUser(
          request, updateUserToTaskRequest.taskId, updateUserToTaskRequest.employeeToAssignId);
    else {
      return request
          .createResponseBuilder(HttpStatus.BAD_REQUEST)
          .body("Please input a valid username and password")
  ...
  public HttpResponseMessage logUserOut(
      @HttpTrigger(
              name = "req",
              methods = {HttpMethod.POST},
              authLevel = AuthorizationLevel.FUNCTION)
          HttpRequestMessage<Optional<LogEmployeeOutRequest>> request,
      final ExecutionContext context) {
  ...
  public HttpResponseMessage getUncompletedTasksBasedOnEmployeeID(
      @HttpTrigger(
              ...
              methods = {HttpMethod.POST},
              authLevel = AuthorizationLevel.FUNCTION)
          HttpRequestMessage<Optional<GetTasksBasedOnUserRequest>> request,
      final ExecutionContext context) {
    GetTasksBasedOnUserRequest getTasksBasedOnUserRequest = request.getBody().orElse(null);
    if (getTasksBasedOnUserRequest != null)
      return taskService.getUncompletedTasksBasedOnEmployeeID(
          request, getTasksBasedOnUserRequest.employeeId);
    else
      return request
          .createResponseBuilder(HttpStatus.BAD_REQUEST)
          .body("Please input a valid username and password")
  ...
  public HttpResponseMessage getCompletedTasksBasedOnEmployeeID(
    ...
    GetTasksBasedOnUserRequest getTasksBasedOnUserRequest = request.getBody().orElse(null);
    if (getTasksBasedOnUserRequest != null)
      return taskService.getCompletedTasksBasedOnEmployeeID(
          request, getTasksBasedOnUserRequest.employeeId);
    else
      return request
          .createResponseBuilder(HttpStatus.BAD_REQUEST)
  ...
  public HttpResponseMessage getAllDiningTables(
      @HttpTrigger(
              name = "req",
              methods = {HttpMethod.GET},
              authLevel = AuthorizationLevel.FUNCTION)
