...
class EmptyTablesList extends StatefulWidget { // class for Waiter Page
  @override
  _EmptyTablesList createState() => _EmptyTablesList();
}
                ...
                Column(
                  children: <Widget>[
                    ...
                    new Align(alignment: Alignment.centerLeft, child: new Text(
                      'Empty Tables', // for the area where the current tasks would be developed
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                gradient: LinearGradient(
                                    begin: Alignment.bottomRight,
                                    colors: [
                                      Colors.limeAccent.withOpacity(0.4), // adding opacity in order to increase visibility
