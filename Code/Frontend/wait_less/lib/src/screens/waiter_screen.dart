  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar( // to edit anything in the appbar
        ...
        elevation: 0, // provides the appbar with 0 elevation to remove the shadow
        title: new Center(child: new Text("Wait Less", style: TextStyle(color: Colors.white, fontFamily: "Poppins-Bold"))), // center the name of the app
                ...
                Container( // this button is for completed tasks
                  ...
                  height: 180,
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        image: AssetImage("assets/image_04.png"), // insert the image here
                        fit: BoxFit.cover
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            Colors.black.withOpacity(0.7), // adding opacity in order to increase visibility
