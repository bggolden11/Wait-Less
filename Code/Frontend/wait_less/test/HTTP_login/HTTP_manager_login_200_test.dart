...
void main() {
  ...
  test('HTTP Authentication API call should return status code 200 OK for manager login', () async {
    int statusCode = 0;
    try {
      ...
      EmployeeLoginCredentials.loginFromJSON(json.decode(response.data.toString()), "2121");
